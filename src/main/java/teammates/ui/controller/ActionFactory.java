...
public class ActionFactory {
    ...
    static{
        map(INSTRUCTOR_DETAILS_ACCOUNT_PAGE, InstructorDetailsAccountPageAction.class);
        map(INSTRUCTOR_DETAILS_ACCOUNT_EDIT, InstructorDetailsAccountEditAction.class);
