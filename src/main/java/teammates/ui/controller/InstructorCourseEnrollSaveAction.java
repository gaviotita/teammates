...
public class InstructorCourseEnrollSaveAction extends Action {
    ...
    public ActionResult execute() throws EntityDoesNotExistException {
        ...
        String studentTeam = getRequestParamValue(Const.ParamsNames.STUDENT_TEAM_INFO);
        String studentEmail = getRequestParamValue(Const.ParamsNames.STUDENT_EMAIL_INFO);
        String studentComment = getRequestParamValue(Const.ParamsNames.STUDENT_COMMENT_INFO);
        String action = getRequestParamValue(Const.ParamsNames.STUDENT_ACTION_INFO);
        if(action.equals("only"))
            studentsInfo = "Team\tName\tEmail\tComment\n"+studentName+"\t"+studentTeam+"\t"+studentEmail+"\t"+studentComment;
