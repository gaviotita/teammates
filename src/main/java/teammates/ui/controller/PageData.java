...
public class PageData {
    ...
    public String getInstructorDetailsAccountLink(){
        String link = Const.ActionURIs.INSTRUCTOR_DETAILS_ACCOUNT_PAGE;
    ...
    public String getInstructorCourseAStudentSaveLink(String courseId){
        //TODO: instead of using this method, the form should include these data as hidden fields?
        String link = Const.ActionURIs.INSTRUCTOR_COURSE_ASTUDENT_SAVE;
        link = Url.addParamToUrl(link,Const.ParamsNames.COURSE_ID,courseId);
        link = addUserIdToUrl(link);
        return link;
    }
