...
public class Const {
    ...
    public class Tooltips{
        ...
        public static final String COURSE_ENROLL = "Inscriba a estudiante en el curso";
        public static final String COURSE_ENROLL_SAMPLE_SPREADSHEET = "Descargar una hoja de cálculo de datos de equipo muestra";
        public static final String COURSE_DETAILS = "Ver, editar y enviar mensajes de correo electrónico de la invitación a los estudiantes en el curso";
        public static final String COURSE_EDIT = "Edición de la información del curso y lista de instructores";
        public static final String COURSE_DELETE = "Eliminar el curso y sus correspondientes alumnos y sesiones";
        public static final String COURSE_ARCHIVE = "Archivar el curso de manera que no se mostrará en la página principal más (todavía se puede acceder a ella desde la pestaña 'Cursos')";
        public static final String COURSE_ADD_EVALUATION = "Añadir una sesión de retroalimentación para el curso";
        public static final String CLAIMED = "Este es el estudiantes propia estimación de su / sus contribuciones";
        public static final String PERCEIVED = "Este es el promedio de lo que otros miembros del equipo piensan que este estudiante contribuyó";
        public static final String PERCEIVED_CLAIMED = "Diferencia entre puntos de cotización reclamados y percibidos";
    
        public static final String COURSE_INSTRUCTOR_EDIT = "Editar detalles del instructor";
        public static final String COURSE_INSTRUCTOR_DELETE = "Eliminar el instructor del curso";
        public static final String COURSE_INSTRUCTOR_REMIND = "Enviar correo electrónico de invitación para el instructor";
        
        public static final String COURSE_STUDENT_DETAILS = "Ver los detalles de la estudiante";
        public static final String COURSE_STUDENT_EDIT = "Utilice esta opción para editar los detalles de este estudiante. <br> Para editar varios estudiantes"
                + " de una sola vez, puedes utilizar la página de inscribirse: <br>Simplemente inscribir a los estudiantes que utilizan los datos actualizados y los datos existentes se actualizarán en consecuencia";
        public static final String COURSE_STUDENT_REMIND = "Enviar una invitación para que el estudiante lo solicita / que se reuniera con el supuesto uso de su / su "
                + "Cuenta de Google. Nota: Los estudiantes pueden utilizar PRIMMATES sin 'unirse', pero un estudiante unido puede acceder a funciones adicionales, por ejemplo configurar un perfil de usuario";
        public static final String COURSE_STUDENT_DELETE = "Eliminar el estudiante y las presentaciones correspondientes del curso";
        public static final String COURSE_STUDENT_RECORDS = "Ver todos los datos acerca de este estudiante";
        public static final String COURSE_STUDENT_COMMENT = "Dé un comentario para este estudiante, su / su equipo / sección";
        
        public static final String COURSE_REMIND = "Enviar una invitación a todos los estudiantes que aún unirse pidiéndoles que participar en el curso"
                + " utilizando sus cuentas de Google. Nota: Los estudiantes pueden utilizar PRMMATES sin 'unirse', pero un estudiante unido puede acceder"
                + " características adicionales, por ejemplo, configurar un perfil de usuario";
        public static final String COURSE_DELETE_ALL_STUDENTS = "Eliminar todos los estudiantes en este curso";
    
        public static final String EVALUATION_STATUS_AWAITING = "Se crea la evaluación, pero aún no ha comenzado";
        public static final String EVALUATION_STATUS_OPEN = "La evaluación ha comenzado y los estudiantes pueden enviar comentarios hasta el momento del cierre";
        public static final String EVALUATION_STATUS_CLOSED = "La evaluación ha terminado, pero los resultados no han sido puestos a disposición de los estudiantes";
        public static final String EVALUATION_STATUS_PUBLISHED = "La evaluación ha terminado y los resultados se han puesto a disposición de los estudiantes";
    
        public static final String EVALUATION_RESULTS = "Ver los resultados actuales de la evaluación";
        public static final String EVALUATION_EDIT = "Editar detalles de la evaluación";
        public static final String EVALUATION_PREVIEW = "Vista previa sesión de evaluación";
        public static final String EVALUATION_REMIND = "Enviar mensajes de correo electrónico para recordar a los estudiantes que no han presentado sus evaluaciones de hacerlo";
        public static final String EVALUATION_DELETE = "Eliminar la evaluación";
        public static final String EVALUATION_PUBLISH = "Publicar los resultados de la evaluación para los estudiantes ver";
        public static final String EVALUATION_UNPUBLISH = "Ofrecer los resultados no son visibles para los estudiantes";
        public static final String EVALUATION_SUBMIT = "Comience evaluación";
        public static final String EVALUATION_EDIT_SUBMISSION = "Editar presentó la evaluación";
        
        public static final String EVALUATION_DIFF = "Contribución Percibido - Contribución Reclamado";
        public static final String EVALUATION_RESPONSE_RATE = "Número de alumnos presentados / Tamaño de la clase";
        public static final String EVALUATION_POINTS_RECEIVED = "La lista de los puntos que el estudiante ha recibido de los demás";
    
        public static final String EVALUATION_INPUT_COURSE = "Por favor seleccione el curso para el que la evaluación se va a crear.";
        public static final String EVALUATION_INPUT_START = "Por favor introduzca la fecha de inicio de la evaluación.";
        public static final String EVALUATION_INPUT_NAME = "Introduzca el nombre de la evaluación, por ejemplo, La evaluación de mitad de período 1.";
        public static final String EVALUATION_INPUT_DEADLINE = "Por favor introduce plazo para la evaluación.";
        public static final String EVALUATION_INPUT_COMMENTSSTATUS = "Habilite esta opción si desea que los estudiantes den comentarios anónimos a los miembros del equipo.<br />"
                + "Usted puede moderar los comentarios de pares antes de publicarlo para el equipo.";
        public static final String EVALUATION_INPUT_TIMEZONE = "Usted no debería tener que cambiar esto como su zona horaria es detectado automáticamente. <br /><br />Sin embargo, tenga en cuenta que el horario de verano no se tiene en cuenta por ejemplo, si usted está en UTC -8: 00 y no hay"
                + "daylight saving, you should choose UTC -7:00 and its corresponding timings.";
        public static final String EVALUATION_INPUT_GRACEPERIOD = "Por favor, seleccione la cantidad de tiempo que el sistema continuará aceptar<br />"
                + "presentaciones después de la fecha límite especificada.";
        public static final String EVALUATION_INPUT_INSTRUCTIONS = "Por favor introduce las instrucciones para sus estudiantes, por ejemplo Evite comentarios que son demasiado críticos.";
    
        public static final String EVALUATION_SUBMISSION_VIEW_REVIEWER = "Mirar información del estudiante para su equipo <br /> Se abrirá en una nueva ventana";
        public static final String EVALUATION_SUBMISSION_VIEW_REVIEWEE = "Mirar información del equipo para el estudiante <br /> Se abrirá en una nueva ventana";
        public static final String EVALUATION_SUBMISSION_INSTRUCTOR_EDIT = "Editar retroalimentación del estudiante para su equipo <br /> Se abrirá en una nueva ventana";
    
        public static final String EVALUATION_SUBMISSION_NOT_AVAILABLE = "No disponible: No hay datos para este o los datos no es suficiente";
        public static final String EVALUATION_SUBMISSION_NOT_SURE = "No estoy seguro acerca de la contribución";
        
        public static final String INSTRUCTOR_DISPLAYED_TO_STUDENT = "Si esto no está seleccionada, el instructor será completamente invisible para los estudiantes." 
                + " Por ejemplo, para dar acceso a un colega de 'auditoría' su curso";
        
        public static final String INSTRUCTOR_DISPLAYED_AS = "Especificar el papel de este instructor de este curso, como se muestra a los estudiantes";
    
        public static final String STUDENT_COURSE_PROFILE = "Su perfil en este curso";
        public static final String STUDENT_COURSE_DETAILS = "Ver y editar información acerca de su equipo";
    
        public static final String STUDENT_EVALUATION_STATUS_PENDING = "La evaluación aún no se ha completado por usted";
        public static final String STUDENT_EVALUATION_STATUS_SUBMITTED = "Has presentado tus comentarios para esta evaluación";
        public static final String STUDENT_EVALUATION_STATUS_CLOSED = "La evaluación ha terminado pero el instructor no ha publicado los resultados aún";
        public static final String STUDENT_EVALUATION_STATUS_PUBLISHED = "La evaluación ha terminado y se puede comprobar los resultados";
        public static final String STUDENT_EVALUATION_STATUS_ERROR = "Hay algunos errores en la recuperación de esta evaluación.";
        ...
        public static final String STUDENT_PROFILE_PICTURE = "Sube una imagen de perfil";
        public static final String STUDENT_PROFILE_SHORTNAME = "Este es el nombre que prefiere ser llamado por";
        public static final String STUDENT_PROFILE_EMAIL = "Este es un correo electrónico de contacto a largo plazo";
        public static final String STUDENT_PROFILE_INSTITUTION = "Esta es la institución que usted representa";
        public static final String STUDENT_PROFILE_NATIONALITY = "Esta es su nacionalidad";
        public static final String STUDENT_PROFILE_MOREINFO = "Puede especificar información diversa acerca de ti mismo"
                + "por ejemplo, vincula a la página, CV en línea, la cartera, etc";
        
        public static final String VISIBILITY_OPTIONS_RECIPIENT = "Controlar lo que  destinatario (s) de retroalimentación puede ver";
        public static final String VISIBILITY_OPTIONS_GIVER_TEAM_MEMBERS = "Controlar lo que los miembros del equipo de dador retroalimentación puede ver";
        public static final String VISIBILITY_OPTIONS_RECIPIENT_TEAM_MEMBERS = "Miembros del equipo de control de lo que los receptores de retroalimentación pueden ver";
        public static final String VISIBILITY_OPTIONS_OTHER_STUDENTS = "Controlar lo que otros estudiantes pueden ver";
        public static final String VISIBILITY_OPTIONS_INSTRUCTORS = "Controlar lo que los instructores pueden ver";
        
        public static final String SHOW_EMAILS = "Mostrar mensajes de correo electrónico de todos los estudiantes anotados en la actualidad";
        
        public static final String COMMENT_ADD = "Añadir comentario";
        public static final String COMMENT_EDIT = "Editar este comentario";
        public static final String COMMENT_DELETE = "Eliminar este comentario";
        
        public static final String SEARCH_STUDENT = "Buscar por nombre del estudiante";
    }
    ...
    public class ActionURIs{
        ...
        public static final String INSTRUCTOR_DETAILS_ACCOUNT_PAGE = "/page/instructorDetailsAccountPage.jsp";

        public static final String INSTRUCTOR_DETAILS_ACCOUNT_EDIT = "/page/instructorDetailsAccountEdit";
    ...
    public class ViewURIs{
        ...
        public static final String INSTRUCTOR_DETAILS_ACCOUNT = "/jsp/instructorDetailsAccount.jsp";        
