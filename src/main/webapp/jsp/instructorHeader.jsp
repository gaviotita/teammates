...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/index.html">PRIMMATES</a>
        </div>
        <div class="collapse navbar-collapse" id="contentLinks">
            <ul class="nav navbar-nav">
                ...
                <li class="<%=data.getClass().toString().contains("InstructorCourse") && !data.getClass().toString().contains("CourseStudent")?"active":""%>">
                    <a class='nav courses' data-link="instructorCourse" href="<%=data.getInstructorCourseLink()%>">Cursos</a>
                </li>
                <li class="<%=(data.getClass().toString().contains("Eval") || data.getClass().toString().contains("Feedback"))?"active":""%>">
                    <a class='nav evaluations' data-link="instructorEval" href="<%=data.getInstructorFeedbackSessionLink()%>">Sesiones</a>
                </li>
                <li class="<%=data.getClass().toString().contains("Student")?"active":""%>">
                    <a class='nav students' data-link="instructorStudent" href="<%=data.getInstructorStudentListLink()%>">Estudiantes</a>
                </li>
                <li class="<%=data.getClass().toString().contains("Comment")?"active":""%>">
                    <a class='nav comments' data-link="instructorComments" href="<%=data.getInstructorCommentsLink()%>">Comentarios</a>
                </li>
                ...
                <li class="<%=data.getClass().toString().contains("MyAccount")?"active":""%>">
            <a class='nav students' data-link="instructorMyAccount" href="<%=data.getInstructorDetailsAccountLink()%>">
                Mi Cuenta
            </a>
        		</li>
                ...
                <li>
                    <a class='nav help' href="/instructorHelp.html" target="_blank">Ayuda</a>
                </li>
            </ul>
