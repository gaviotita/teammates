...
<body onload="readyFeedbackPage();">
    ...
    <div id="frameBodyWrapper" class="container theme-showcase">
        ...
        <h1>Añadir Nueva Sesion de Retroalimentacion</h1>
        ...
        <div class="well well-plain">
            <form class="form-group" method="post"
                ...
                <div class="row">
                    <h4 class="label-control col-md-2 text-md">Crear nueva </h4>
                    <div class="col-md-5">
                        <div class="col-md-10"
                        ...
                        data-placement="top">
                            <select class="form-control"
                                ...
                                <option value="STANDARD" <%= (data.feedbackSessionType != null && data.feedbackSessionType.equals("STANDARD")) ? "selected=\"selected\"" : "" %> >
                                    Sesion con sus propias preguntas
                                </option>                               
                                <option value="TEAMEVALUATION" <%= (data.feedbackSessionType == null || data.feedbackSessionType.equals("TEAMEVALUATION")) ? "selected=\"selected\"" : "" %> >
                                    Sesion de evaluacion por equipo
                                </option>
                            </select>
                        </div>
                        <div class="col-md-1">
                    ...
                    <h4 class="label-control col-md-1 text-md">O: </h4>
                    <div class="col-md-3">
                        <a id="button_copy" class="btn btn-info" style="vertical-align:middle;">Copiar
                            de sesiones de retroalimentacion anteriores</a>
                    </div>
                </div>
                <br>
                                ...
                                <div class="form-group">
                                    <h5 class="col-sm-4">
                                        <label for="<%=Const.ParamsNames.COURSE_ID%>"
                                            class="control-label">Curso</label>
                                    </h5>
                                    <div class="col-sm-8">
                                        <select class="form-control"
                                ...
                                <div class="form-group">
                                    <h5 class="col-sm-4">
                                        <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_TIMEZONE%>"
                                            class="control-label">Zona Horaria</label>
                                    </h5>
                                    <div class="col-sm-8">
                                        <select class="form-control"
                                ...
                                <div class="form-group">
                                    <h5 class="col-sm-2">
                                        <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_INSTRUCTIONS%>"
                                            class="control-label">Instrucciones</label>
                                    </h5>
                                    <div class="col-sm-10">
                                        <textarea
                                            class="form-control"
                                            ...
                                            placeholder="e.g. Por favor responder todas las preguntas dadas."
                                            ><%
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_STARTDATE%>"
                                            class="label-control">
                                            Tiempo de apertura de la sesión</label>
                                    </div>
                                </div>
                                <!-- wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwddwad -->
                                <div class="row">
                                    <div class="col-md-6">
                                        <input
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="<%=Const.ParamsNames.FEEDBACK_SESSION_ENDDATE%>"
                                            class="label-control">Tiempo de cierre de  sesión</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                ...
                <div class="row" id="uncommonSettingsInfo">
                    <div class="col-md-12 text-muted">
                        ...
                        <a id="editUncommonSettingsButton" data-edit="[Edit]" data-done="[Done]">[Editar]</a>
                        <br><br>
                    </div>
                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row radio">
                                    <div class="col-md-2"
                                        ...
                                        data-placement="top">
                                        <label
                                            for="<%=Const.ParamsNames.FEEDBACK_SESSION_SESSIONVISIBLEBUTTON%>_custom">en
                                ...
                                <div class="row radio">
                                    <div class="col-md-6"
                                        ...
                                        data-placement="top">
                                        <label
                                            for="<%=Const.ParamsNames.FEEDBACK_SESSION_SESSIONVISIBLEBUTTON%>_atopen">Tiempo de apertura de la sesión
                                            </label> <input
                                            type="radio"
                                            name="<%=Const.ParamsNames.FEEDBACK_SESSION_SESSIONVISIBLEBUTTON%>"
                                ...
                                <div class="row radio">
                                    <div class="col-md-6"
                                        ...
                                        data-placement="top">
                                        <label
                                            for="<%=Const.ParamsNames.FEEDBACK_SESSION_SESSIONVISIBLEBUTTON%>_never">Nunca
                                            (esto es una sesión privada)</label>
                                        <input type="radio"
                                            name="<%=Const.ParamsNames.FEEDBACK_SESSION_SESSIONVISIBLEBUTTON%>"
                            ...
                            <div class="col-md-6 border-left-gray" id="responsesVisibleFromColumn">
                                <div class="row">
                                    <div class="col-md-6"
                                        ...
                                        data-toggle="tooltip"
                                        data-placement="top">
                                        <label class="label-control">Respuestas
                                            visibles desde</label>
                                    </div>
                                </div>
                                <div class="row radio">
                                    <div class="col-md-2"
                                        ...
                                        data-placement="top">
                                        <label
                                            for="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>_custom">En</label>
                                ...
                                <div class="row radio">
                                    <div class="col-md-3"
                                        ...
                                        data-placement="top">
                                        <label
                                            for="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>_atvisible">Inmediatamente</label>
                                        <input type="radio"
                                            name="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>"
                                ...
                                <div class="row radio">
                                    <div class="col-md-4"
                                        ...
                                        data-placement="top">
                                        <label
                                            for="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>_later">Publicar
                                            manualmente</label> <input type="radio"
                                ...
                                <div class="row radio">
                                    <div class="col-md-2"
                                        ...
                                        data-placement="top">
                                        <label
                                            for="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>_never">Nunca</label>
                                        <input type="radio"
                                            name="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>"
                ...
                <div class="panel panel-primary" style="display:none;" id="sendEmailsForPanel">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <label class="control-label">Enviar 
                                    emails para</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-3"
                                ...
                                data-placement="top">
                                <div class="checkbox">
                                    <label>Sesión de recordatorio de apertura
                            ...
                            <div class="col-sm-3"
                                ...
                                <div class="checkbox">
                                    <label
                                        for="<%=Const.ParamsNames.FEEDBACK_SESSION_SENDREMINDEREMAIL%>_closing">Recoradtorio de cerrar 
                                        sesión</label> <input
                                        type="checkbox"
                                        checked="checked"
                                        name="<%=Const.ParamsNames.FEEDBACK_SESSION_SENDREMINDEREMAIL%>"
                            ...
                            <div class="col-sm-4"
                                ...
                                <div class="checkbox">
                                    <label
                                        for="<%=Const.ParamsNames.FEEDBACK_SESSION_SENDREMINDEREMAIL%>_published">Anuncio de los resultados 
                                        publicados</label> <input
                                        type="checkbox"
                                        checked="checked"
                                        name="<%=Const.ParamsNames.FEEDBACK_SESSION_SENDREMINDEREMAIL%>"
                ...
                <div class="form-group">
                    <div class="col-md-offset-5 col-md-3">
                        <button id="button_submit" type="submit" class="btn btn-primary">Crear Sesión de rettroalimentación</button>
                    </div>
                </div>
                <input type="hidden"
            ...
            <thead>
                <tr class="fill-primary">
                    <th id="button_sortid" onclick="toggleSort(this,1);"
                        class="button-sort-ascending">ID de Curso<
                        class="icon-sort unsorted"></span>
                    </th>
                    <th id="button_sortname" onclick="toggleSort(this,2)"
                        class="button-sort-none">Nombre de sesión<span
                        class="icon-sort unsorted"></span>
                    </th>
                    <th>Estado</th>
                    <th><span
                        ...
                        data-toggle="tooltip" data-placement="top">
                            razón de respuesta</span></th>
                <th class="no-print">Accion(es)</th>
            </tr>
            </thead>
            <%
                int sessionIdx = -1;
            ...
            <tr class="sessionsRow" id="session<%=sessionIdx%>">
                ...
                <td
                    ...
                    href="<%=data.getFeedbackSessionStatsLink(fdb.courseId,
                            fdb.feedbackSessionName)%>">Mostrar</a>
                </td>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="modalCopiedCourseId"
                                class="control-label">Crear en el curso</label>
                        <select class="form-control"
                    ...
                    <div class="form-group">
                        <label for="modalCopiedSessionName"
                            class="control-label">Nombre para la nueva sesión</label>
                        <input class="form-control"
                            type="text"
              ...
              <div class="modal-footer margin-0">
                <button type="button" class="btn btn-primary" id="button_copy_submit" disabled="disabled">Copiar</button>
        ...
        <%
            if (sessionIdx == -1) {
        %>
        <div class="align-center">No se encontraron registros.</div>
        <br> <br> <br>
        <%
            }
        %>
