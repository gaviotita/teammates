...
<div id="footerComponent" class="container-fluid">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <span>[<a href="/index.html">PRIMMATES</a> V<%=version%>]</span>
            </div>
            <div class="col-md-4">
                <%
                    if(institute != null && institute != "") {
                %>
                        [Para <span class="highlight-white"><%=institute%></span>]
                <% } %>
            </div>
            <div class="col-md-4">
                <span>[Enviar <a class="link" href="../contact.html" target="_blank">Retroalimentación</a>]</span>
            </div>
        </div>
    </div>
</div>