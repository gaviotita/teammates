            ...
            <div class="inner-container">
                <div class="row">
                        ...
                        <form method="get" action="<%=data.getInstructorSearchLink()%>" name="search_form">
                            <div class="input-group">
                                <input type="text" id="searchbox"
                                            ...
                                            data-toggle="tooltip"
                                            data-placement="top"
                                            placeholder="Nombre del Estudiante"><!-- Student name -->
                    ...
                    <div class="col-md-2 instructor-header-bar">
                        <a class="btn btn-primary btn-md" href="<%=data.getInstructorCourseLink() %>" id="addNewCourse">Añadir nuevo curso </a>
                    </div>
                </div>
            </div>
            <br>
                ...
                <div class="col-md-5 pull-right">
                    <div class="row">
                        <div class="col-md-3 btn-group">
                            <h5 class="pull-right"><strong> Ordenar Por: </strong></h5>
                        </div>
                        <div class="col-md-9">
                                ...
                                <div class="col-md-6">
                                    <span class="pull-right">
                                         ...
                                         <a class="btn btn-primary btn-xs btn-tm-actions course-view-for-test"
                                            ...
                                            title="<%=Const.Tooltips.COURSE_DETAILS%>" data-toggle="tooltip" data-placement="top"> Ver</a> 
                                         ...
                                         <a class="btn btn-primary btn-xs btn-tm-actions course-edit-for-test"
                                            ...
                                            title="<%=Const.Tooltips.COURSE_EDIT%>" data-toggle="tooltip" data-placement="top"> Editar</a>
                                         ...
                                         <a class="btn btn-primary btn-xs btn-tm-actions course-archive-for-test"
                                            ...
                                            onclick="return toggleArchiveCourseConfirmation('<%=courseDetails.course.id%>')">Archivar</a>
                                    ...
                                    <thead>
                                        <tr>
                                            <th id="button_sortname" onclick="toggleSort(this,1);"
                                                ...
                                                Nombre de Sesion<span class="icon-sort unsorted"></span></th>
                                            <th>Estado</th>
                                            <th>
                                                <span title="<%=Const.Tooltips.EVALUATION_RESPONSE_RATE%>" data-toggle="tooltip" data-placement="top">Razon de Respuesta</span>
                                            </th>
                            ...
                            %>
                                    <tr id="session<%=sessionIdx%>">
                                        ...
                                        <td class="session-response-for-test<% 
                                            ...
                                            <a oncontextmenu="return false;" href="<%=data.getFeedbackSessionStatsLink(fdb.courseId, fdb.feedbackSessionName)%>">Mostrar</a>
                                        </td>
